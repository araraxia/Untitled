...
class NewGameManager:
    ...
    def init_new_character(
        ...
        if stats:
            ...
            if background:
                base_stats['strength'] += background.strength_modifier
                base_stats['dexterity'] += background.dexterity_modifier
                base_stats['intelligence'] += background.intelligence_modifier
                base_stats['willpower'] += background.willpower_modifier
                base_stats['charisma'] += background.charisma_modifier
                base_stats['perception'] += background.perception_modifier
                base_stats['endurance'] += background.endurance_modifier
                base_stats['luck'] += background.luck_modifier
                base_stats['speed'] += background.speed_modifier
                base_stats['soul_power'] += background.soul_power_modifier
                base_stats['combat_sense'] += background.combat_sense_modifier
        ...
        if self.player_character:
            ...
            # Save entity to file
            from pathlib import Path
            entity_dir = Path("frontend/assets/data/entity")
            entity.save_to_file(entity_dir)
